...
bool pioneer_msgs__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pioneer_msgs.msg._status.Status", full_classname_dest, 31) == 0);
  }
  pioneer_msgs__msg__Status * ros_message = _ros_message;
  {  // header
...
PyObject * pioneer_msgs__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pioneer_msgs.msg._status");
