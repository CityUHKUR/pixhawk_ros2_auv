...
#include "pioneer_msgs/msg/detail/auv_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pioneer_msgs::msg::AUVState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.current_control;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pioneer_msgs::msg::AUVState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pioneer_msgs::msg::AUVState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pioneer_msgs::msg::AUVState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pioneer_msgs::msg::AUVState *>(
    untyped_ros_message);
...
{
  return &pioneer_msgs::msg::typesupport_fastrtps_cpp::_AUVState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pioneer_msgs, msg, AUVState)() {
  return &pioneer_msgs::msg::typesupport_fastrtps_cpp::_AUVState__handle;
}
