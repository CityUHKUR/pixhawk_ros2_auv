...
#include "pioneer_msgs/msg/detail/motion_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_pioneer_msgs
cdr_serialize(
  const pioneer_msgs::msg::MotionCommand & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: turn_mode
  cdr << (ros_message.turn_mode ? true : false);
  // Member: direction
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pioneer_msgs::msg::MotionCommand & ros_message)
{
  // Member: header
  ...
  // Member: turn_mode
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.turn_mode = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: turn_mode
  {
    size_t item_size = sizeof(ros_message.turn_mode);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pioneer_msgs::msg::MotionCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pioneer_msgs::msg::MotionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pioneer_msgs::msg::MotionCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_pioneer_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<pioneer_msgs::msg::MotionCommand>()
{
  return &pioneer_msgs::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pioneer_msgs, msg, MotionCommand)() {
  return &pioneer_msgs::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
