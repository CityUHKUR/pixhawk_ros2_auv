...
#include "pioneer_msgs/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pioneer_msgs::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pioneer_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pioneer_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  return &pioneer_msgs::msg::typesupport_fastrtps_cpp::_Status__handle;
}
