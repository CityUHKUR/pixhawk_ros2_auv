...
#include "pioneer_msgs/msg/detail/motion_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotionCommand__ros_msg_type = pioneer_msgs__msg__MotionCommand;
...
static uint32_t _MotionCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pioneer_msgs__msg__MotionCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pioneer_msgs__msg__MotionCommand;
    is_plain =
      (
...
static size_t _MotionCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pioneer_msgs__msg__MotionCommand(
