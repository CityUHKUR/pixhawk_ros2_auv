...
class Metaclass_AUVState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('pioneer_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'pioneer_msgs.msg.AUVState')
            logger.debug(
...
class AUVState(metaclass=Metaclass_AUVState):
    ...
    def __init__(self, **kwargs):
        ...
        self.current_control = kwargs.get('current_control', str())
    ...
    def __eq__(self, other):
        ...
        if self.current_state != other.current_state:
            return False
        if self.current_control != other.current_control:
            return False
        return True
    ...
    def current_control(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'current_control' field must be of type 'str'"
