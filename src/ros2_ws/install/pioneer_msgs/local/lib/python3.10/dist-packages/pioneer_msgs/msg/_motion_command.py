    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pioneer_msgs.msg.MotionCommand')
            logger.debug(
...
class MotionCommand(metaclass=Metaclass_MotionCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.turn_mode = kwargs.get('turn_mode', bool())
        from geometry_msgs.msg import Vector3
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.turn_mode != other.turn_mode:
            return False
    ...
    def turn_mode(self, value):
        if __debug__:
            assert \
                ...
                "The 'turn_mode' field must be of type 'bool'"
